...
export default function CricketMatchDetails() {
    const { getCricketDetails, cricketDetails, location, countryCode,activeEvenBanners, activeOddBanners, bannerLoading, setShowOtherDivs, showOtherDivs ,upcomingMatches,UpcomingFootballMatches,sport} = useGlobalData();
